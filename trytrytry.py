...
# Initialize Pygame in full screen mode
...
while running:
    ...
    pygame.draw.circle(screen, RED, (300, 300), circle.radius)

    display_text(rectangle.display(), 50, 500, RED)
    pygame.draw.rect(screen, RED, (300, 500, rectangle.width, rectangle.height))

    display_text(triangle.display(), 50, 900, RED)
    pygame.draw.polygon(screen, RED, [(300, 900), (300 + triangle.base, 900), (300 + triangle.base / 2, 900 - triangle.height)])
